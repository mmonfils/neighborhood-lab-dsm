# Pull Up a Chair: How to Help Out!
...
## Simple Ways You Can Pitch In

### 1. Spreading the Word on the Index
...
* **Keep it Casual and Kind:** We follow standard front-porch rules here. Treat everyone like a next-door neighbor, leave political arguments at the gate, and focus entirely on practical, local block competence. 
* **Strictly Outside the Cloud:** We never collect, track, or share private data on our neighbors. Any template or tracker we build must be able to run completely offline on a basic computer using simple, standard spreadsheet formats.
* **A Free Gift to the Block:** Everything we create in this workshop is dedicated to the public domain under a CC0 1.0 Universal license. That means any guide, map, or template you contribute becomes a free public asset that anyone can copy, modify, or share without restrictions. 

Thanks for pulling up a chair and helping us look after our streets!

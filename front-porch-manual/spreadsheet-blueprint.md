...
Keeping personal information safe is just part of watching out for the neighborhood. These templates ensure privacy by design:

* **No Full Names:** Use everyday descriptions like `Dave (Apt 3C)`, `Sarah (Apt 4B)`, or `Marcus (Yellow House)`.
* **No Address Columns:** Never record specific street numbers, phone numbers, email addresses, or financial info.
* **Keep Data Offline:** Keep all files stored safely on local computer hard drives or print them out on paper. Avoid cloud storage or third-party tracking programs that could expose household information to outside groups or companies.

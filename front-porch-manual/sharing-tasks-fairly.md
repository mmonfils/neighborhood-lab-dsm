...
* **Keep it local.** If city groups, political organizations, outside entities, or institutional programs ask for our block maps, role logs, or data lists, we politely say no. This network belongs strictly to the households on the block grid. We share continuous updates, resources, and advice on rotating block roles on our [Substack newsletter](https://neighborhoodlabdsm.substack.com/).

...
This file explains how to distribute block tasks so that everyone helps out and no single person ends up running the street or acting like an institutional gatekeeper. Following the framework modeled by Maria Pearson, we pass these simple roles around to ensure our tools stay accessible to everyday people and our block stays completely self reliant.
